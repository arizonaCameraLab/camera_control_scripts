...
git clone https://github.com/arizonaCameraLab/camera_control_scripts.git
cp -r ./camera_control_scripts/Arducam_example ~/Desktop/Arducam_example
cp ~/Desktop/Arducam_example/remote_control_scripts/camera_side/* ~/
