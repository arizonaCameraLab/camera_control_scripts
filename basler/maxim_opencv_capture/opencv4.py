...
camera = pylon.InstantCamera(tlFactory.CreateDevice(devices[3]))
...
print("Grab finished, saving images cam04")
print("Total runtime cam04: " + str(end_time-start_time) + " seconds")
print("Frames/second cam04: " + str(max_frames/(end_time-start_time)))
...
for i in range(max_frames):
    filename = '4_' + str(i) + '_savedImage.png'
