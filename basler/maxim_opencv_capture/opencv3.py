...
print("Grab finished, saving images cam03")
print("Total runtime cam03: " + str(end_time-start_time) + " seconds")
print("Frames/second cam03: " + str(max_frames/(end_time-start_time)))
...
for i in range(max_frames):
    filename = '3_' + str(i) + '_savedImage.png'
