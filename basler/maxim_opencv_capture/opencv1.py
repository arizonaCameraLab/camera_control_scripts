...
print("Grab finished, saving images cam01")
print("Total runtime cam01: " + str(end_time-start_time) + " seconds")
print("Frames/second cam01: " + str(max_frames/(end_time-start_time)))
...
for i in range(max_frames):
    filename = '1_' + str(i) + '_savedImage.png'
