...
camera = pylon.InstantCamera(tlFactory.CreateDevice(devices[6]))
...
print("Grab finished, saving images cam07")
print("Total runtime cam07: " + str(end_time-start_time) + " seconds")
print("Frames/second cam07: " + str(max_frames/(end_time-start_time)))
...
for i in range(max_frames):
    filename = '7_' + str(i) + '_savedImage.png'
