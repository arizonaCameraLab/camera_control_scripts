...
camera = pylon.InstantCamera(tlFactory.CreateDevice(devices[1]))
...
print("Grab finished, saving images cam02")
print("Total runtime cam02: " + str(end_time-start_time) + " seconds")
print("Frames/second cam02: " + str(max_frames/(end_time-start_time)))
...
for i in range(max_frames):
    filename = '2_' + str(i) + '_savedImage.png'
