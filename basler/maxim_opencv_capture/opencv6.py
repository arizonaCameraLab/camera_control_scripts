...
camera = pylon.InstantCamera(tlFactory.CreateDevice(devices[5]))
...
print("Grab finished, saving images cam06")
print("Total runtime cam06: " + str(end_time-start_time) + " seconds")
print("Frames/second cam06: " + str(max_frames/(end_time-start_time)))
...
for i in range(max_frames):
    filename = '6_' + str(i) + '_savedImage.png'
